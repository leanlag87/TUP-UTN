...
try:
    with conexion:
        with conexion.cursor() as cursor:
            sentencia = "DELETE FROM persona WHERE id_persona IN %s" # Definimos la sentencia SQL para eliminar datos en la tabla persona
            entrada = input("Ingrese qué id personas deseas eliminar? (separados por comas) ") # Solicitamos al usuario el id_persona a eliminar
